...
<div class="container">
    <form method="post" id="formEditarcaso">
        <div class="jumbotron shadow">
            <div class="container-fluid">
                <h4>Datos de la persona</h4>
                <?php foreach($casos as $caso){?>
                <input type="hidden" name="idpersona" value="<?php echo $caso->DATOS_PERSONAS_Id; ?>">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="telefono" placeholder="Este campo esta vacío" value="<?php echo $caso->Telefono;?>" required>
                            </div>
                            <div class="col-md-4">
                                <strong><label for="direccion">Direccion<b class="text-danger">*</b></label></strong>
                                <input type="text" class="form-control" name="direccion" placeholder="Este campo esta vacío" value="<?php echo $caso->Direccion;?>" required>
                            </div>
                            <div class="col-md-4">
                                <strong><label for="email">Correo</label></strong>
                                <input type="email" class="form-control" name="email" placeholder="Este campo esta vacío" value="<?php echo $caso->Correo;?>">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-3">
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="id_segcovid" placeholder="Este campo esta vacío" value="<?php echo $caso->Id_Caso_SegCovid;?>">
                            </div>
                            <div class="col-md-4">
                                <strong><label for="id_ins">Id Caso INS</label></strong>
                                <input type="text" class="form-control" name="id_ins" placeholder="Este campo esta vacío" value="<?php echo $caso->Id_Caso_INS;?>">
                            </div>
                            <div class="col-md-4">
        ...
        <button type="submit" class="btn btn-success btn-lg mb-5 float-right">Actualizar</button>
...
<script type="text/javascript">
    ...
    $('#formEditarcaso').submit(function(event)
    {
        var parametros = $('#formEditarcaso').serialize();
        console.log(parametros);
        var salida="";
            $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('casos/EditarCaso');?>",
                    data: parametros,
                    beforeSend: function() {
                    $('#resultados').show();
                    },
